...
public class LibraryInfoController {
    ...
    RestTemplate pt;
     ...
     public List<Books> getExternalTeam(){
    	 ...
    	 ResponseEntity<Books[]> response = rt.getForEntity("http://localhost:8082/books", Books[].class);
     ...
     public List<User> getExternalPlayer(){
    	 ...
    	 ResponseEntity<User[]> response = pt.getForEntity("http://localhost:8080/users", User[].class);
